...
class ThreadManagement:
    ...
    def move_thread_thread(self, thread: ThreadManagement, targetPoolName: str, create_new_thread: bool=False, remove_from_old_pool: bool=True) -> bool:
        """
    ...
    def remove_thread_thread(self, removeThread: ThreadManagement, targetPoolName:str=None, level:str=None) -> bool:
        """
    ...
    def get_thread(self, pid: str, level: str = None,  limit: tuple[str, ...] = None,
                   eliminate: tuple[str, ...] = None) -> tuple[ThreadManagement, str, str] or None:
        """
    ...
    def get_threads(self, pids: ThreadOrPid,  level: str = None, limit: tuple[str, ...] = None,
                    eliminate: tuple[str, ...] = None) -> tuple[tuple[ThreadManagement, str, str], ...]:
        """
